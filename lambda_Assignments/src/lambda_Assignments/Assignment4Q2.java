...
public class Assignment4Q2 {
	...
	public static void main(String[] args) {
		...
		a.add(new Assignment4Q2(10000, "pending"));
		a.add(new Assignment4Q2(100001, "accepted"));
		a.add(new Assignment4Q2(125000, "completed"));
		a.add(new Assignment4Q2(12500, "completed"));
		a.add(new Assignment4Q2(125,"pending"));

		Predicate<Assignment4Q2> pr = e -> (e.totalPrice > 10000
				&& (e.status.contentEquals("accepted") || e.status.contentEquals("completed")));
		listOfOrders(a, pr);
